    ...
    async bootstrap({ strapi }) {
        ...
        setTimeout(async () => {
            try {
                ...
                if ((existing === null || existing === void 0 ? void 0 : existing.documentId) && (existing.name == null || existing.name === '')) {
                    try {
        ...
        try {
            ...
            if (contentType) {
                ...
                await cmService.updateConfiguration(contentType, {
                    ...config,
                    settings: {
                        ...config === null || config === void 0 ? void 0 : config.settings,
                        mainField: 'siteName',
                    },
                    layouts: {
                        ...config === null || config === void 0 ? void 0 : config.layouts,
        ...
        try {
            ...
            if (navContentType) {
                ...
                await cmService.updateConfiguration(navContentType, {
                    ...navConfig,
                    settings: {
                        ...navConfig === null || navConfig === void 0 ? void 0 : navConfig.settings,
                        mainField: 'name',
                    },
                    layouts: {
                        ...navConfig === null || navConfig === void 0 ? void 0 : navConfig.layouts,
        ...
        try {
            ...
            if (formContentType) {
                ...
                await cmService.updateConfiguration(formContentType, {
                    ...formConfig,
                    settings: {
                        ...formConfig === null || formConfig === void 0 ? void 0 : formConfig.settings,
                        mainField: 'name',
                    },
                    layouts: {
                        ...formConfig === null || formConfig === void 0 ? void 0 : formConfig.layouts,
