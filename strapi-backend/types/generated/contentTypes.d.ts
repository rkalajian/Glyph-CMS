...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts for the CMS';
    displayName: 'Blogs';
...
export interface ApiFormSubmissionFormSubmission
  ...
  info: {
    description: 'Submitted form data from the form builder';
...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Form builder for contact forms and surveys. Use the embed code to add forms to any page or post.';
    displayName: 'Form';
    pluralName: 'forms';
    singularName: 'form';
  };
  ...
  attributes: {
    ...
    notifySubmitter: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    ...
    successMessage: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Thank you! Your submission has been received.'>;
    successRedirectUrl: Schema.Attribute.String;
    successType: Schema.Attribute.Enumeration<['message', 'redirect']> &
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site navigation: Utility Nav, Primary Nav, and Footer Nav';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerNav: Schema.Attribute.Component<'navigation.nav-link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Navigation'>;
    primaryNav: Schema.Attribute.Component<'navigation.nav-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    utilityNav: Schema.Attribute.Component<'navigation.nav-link', true>;
  };
}
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages for the CMS';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickLinks: Schema.Attribute.Component<'blocks.quick-link', true>;
    seoDescription: Schema.Attribute.Text;
    seoTitle: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiPressReleaseCategoryPressReleaseCategory
  ...
  info: {
    description: 'Categories for press releases';
    displayName: 'Press Release Categories';
...
export interface ApiPressReleasePressRelease
  ...
  info: {
    description: 'Press releases for the CMS';
...
export interface ApiSiteAlertSiteAlert extends Struct.CollectionTypeSchema {
  collectionName: 'site_alerts';
  info: {
    description: 'Site-wide alerts with schedule';
    displayName: 'Site Alert';
    pluralName: 'site-alerts';
    singularName: 'site-alert';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiThemeOptionsThemeOption extends Struct.SingleTypeSchema {
  collectionName: 'theme_options';
  info: {
    description: 'Site-wide theme settings: logo, GTM, Marker.io, breadcrumbs, and social links';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::theme-options.theme-option'
    > &
      Schema.Attribute.Private;
