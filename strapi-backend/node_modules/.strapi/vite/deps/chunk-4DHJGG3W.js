...
} from "./chunk-SMCCYE23.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-MWUH2ODE.js";
import {
  require_pick
} from "./chunk-3UQDYV6P.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-754FWM2O.js";
import {
  useGetAIUsageQuery
} from "./chunk-ZXZKW465.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-VZPJAFEP.js";
import {
  require_baseRest
} from "./chunk-S6DOM4GB.js";
import {
  HistoryProvider
} from "./chunk-GIETFSC4.js";
import {
  useEnterprise
} from "./chunk-VXPDVQPH.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-3IEKMKIS.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-MCXCOB5K.js";
import {
  Layouts
} from "./chunk-KZABSQ3Z.js";
import {
  Login
} from "./chunk-W4ZWQGMO.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-ZGGHXTFH.js";
import {
  ConfigurationProvider
} from "./chunk-A2SADGU7.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-74GQUWXD.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-DEENX5NO.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-Z3WILOS5.js";
import {
  MemoizedInputRenderer
} from "./chunk-7XLR6HFS.js";
import {
  Form
} from "./chunk-HDFV7L3U.js";
import {
  getByteSize
...
} from "./chunk-ILBDRNS5.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-ZC6KLP6J.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-KIKLOZBV.js";
import {
...
var defaultContext = import_react2.default.createContext(void 0);
var QueryClientSharingContext = import_react2.default.createContext(false);
...
var QueryClientProvider = function QueryClientProvider2(_ref) {
  ...
  return import_react2.default.createElement(QueryClientSharingContext.Provider, {
...
function useMutation(arg1, arg2, arg3) {
  ...
  var obsRef = import_react6.default.useRef();
  if (!obsRef.current) {
  ...
  var mutate = import_react6.default.useCallback(function(variables, mutateOptions) {
...
function useQueries(queries) {
  ...
  var queryClient2 = useQueryClient();
  var defaultedQueries = (0, import_react8.useMemo)(function() {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-WHND7LTP.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-DOAX26SE.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-FPQSG4EG.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-KACYRV7D.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-RWNDBESL.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-IADJWG2V.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-NKFDLPMF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-AJWROT2K.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BKQJOMXE.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-FHQ4XOQY.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-FLFTSWCS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UKZPD6TT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-G5NXXHWQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-OU74GO5I.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-BVRPYINC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-6447KDVP.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-QK3P2HFZ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-VCE3565Q.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-DBJ2EXXD.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-LZJPQTMH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-I3VZJPES.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-IBOH4ZWJ.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-RT52EJJE.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-66RHPBRR.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-4G2YI2RD.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-V572DIPO.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-JJXSA2EV.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-AUYPMRLO.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-G7FOWE25.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-G7FOWE25.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-PUZRHMQG.js");
...
//# sourceMappingURL=chunk-4DHJGG3W.js.map
