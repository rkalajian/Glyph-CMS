  ...
  return (
    <section className="bg-gray-2 py-24 dark:bg-dark">
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[970px] overflow-hidden rounded bg-white shadow-card dark:bg-dark-2">
          <div className="relative z-20 h-[140px] sm:h-[160px] md:h-auto">
            ...
            <div className="absolute bottom-5 right-5 z-10">
              <label
                htmlFor="cover"
                className="flex h-9 w-9 cursor-pointer items-center justify-center rounded border border-white border-opacity-[35%] bg-white bg-opacity-30 text-white hover:bg-opacity-20"
              >
                <input
                  type="file"
                  name="cover"
          ...
          <div className="flex flex-wrap px-5 pb-9 pt-6 sm:px-9 md:flex-nowrap">
            <div className="relative -top-14 z-30 h-[120px] w-full max-w-[120px] rounded-full border-4 border-white shadow-card dark:border-dark sm:h-[160px] sm:max-w-[160px]">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-2 right-2 flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90"
              >
                <svg
                  width="14"
                  height="14"
