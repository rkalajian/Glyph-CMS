  ...
  return (
    <section className="bg-gray-2 py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="border-stroke relative flex max-w-[560px] rounded-lg border bg-white p-[25px]">
          ...
          <div className="w-full pr-4 sm:pr-10">
            ...
            <button className="text-body-color hover:text-danger absolute top-5 right-5">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
