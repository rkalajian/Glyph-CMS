            ...
            <div className="2xl:pl-8">
              <div>
                ...
                <form className="flex">
                  <input
                    type="email"
                    className="border-form-stroke text-body-color focus:border-primary mr-3 mb-3 h-[48px] w-full border bg-white px-5 text-base font-medium outline-none focus-visible:shadow-none"
                    placeholder="Coupon code"
                  />
                  <button className="bg-primary mb-3 h-[48px] px-6 text-base font-medium text-white transition hover:bg-opacity-90">
                    Submit
                  </button>
                </form>
              </div>
              ...
              <div className="mb-5">
                <button className="bg-primary flex w-full items-center justify-center py-[10px] px-10 text-center text-base font-normal text-white hover:bg-opacity-90">
                  Checkout
                </button>
              </div>
        ...
        <div className="mb-4 w-full justify-between sm:flex">
          ...
          <div className="mr-4">
            ...
            <div className="relative inline-block">
              <select className="border-form-stroke text-body-color focus:border-primary active:border-primary w-full appearance-none border py-1 pl-4 pr-7 text-sm font-semibold outline-none transition disabled:cursor-default disabled:bg-[#F5F7FD]">
