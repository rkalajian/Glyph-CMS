          ...
          <div className="p-[30px]">
            ...
            <form className="relative">
              <input
                ...
                className="h-[58px] w-full rounded-[10px] border border-transparent bg-white pl-[60px] pr-[100px] text-base text-body-color shadow-chat-box outline-none focus:border-secondary dark:bg-dark dark:text-dark-6"
              />
              ...
              <div className="absolute right-3 top-1/2 inline-flex -translate-y-1/2 items-center justify-end space-x-[18px]">
                ...
                <button className="flex h-9 w-9 items-center justify-center rounded-md bg-secondary hover:bg-opacity-90">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
