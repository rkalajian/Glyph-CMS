  ...
  return (
    <div className="mb-6">
      <input
        ...
        name={name}
        className="w-full rounded-lg border border-transparent bg-white/20 px-[14px] py-3 text-base text-white placeholder-white placeholder-opacity-60 outline-none focus:border-white focus-visible:shadow-none"
      />
    </div>
  );
};
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none rounded-lg border border-transparent bg-white/20 px-[14px] py-3 text-base text-white placeholder-white placeholder-opacity-60 outline-none focus:border-white focus-visible:shadow-none"
