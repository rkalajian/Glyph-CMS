      ...
      >
        ...
        >
          ...
          <button
            ...
            className="absolute right-6 top-6 flex h-7 w-7 items-center justify-center rounded-full bg-white bg-opacity-10 text-white transition hover:bg-opacity-100 hover:text-primary"
          >
            <svg
              width="10"
              height="10"
