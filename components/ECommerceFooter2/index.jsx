                ...
                <div className="mb-14">
                  ...
                  <form className="flex items-center justify-between">
                    <input
                      ...
                      className="h-[54px] w-full rounded-bl-lg rounded-tl-lg border border-stroke bg-white px-5 outline-none focus:border-primary dark:border-dark-3 dark:bg-dark"
                    />
