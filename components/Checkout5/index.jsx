                        ...
                        <div className="mb-8">
                          ...
                          >
                            <div className="relative">
                              ...
                              />
                              <div className="mr-[10px] flex h-5 w-5 items-center justify-center rounded border border-stroke bg-transparent peer-checked:border-primary peer-checked:bg-primary dark:border-dark-3">
              ...
              <div className="mb-10 overflow-hidden rounded-[10px] border border-stroke px-6 py-10 shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark sm:px-10 lg:px-8 2xl:px-10">
                ...
                <form className="relative">
                  <input
                    ...
                    className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-5 pr-20 text-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
                  />
                  <button className="absolute right-2 top-1/2 mb-3 h-[34px] -translate-y-1/2 rounded bg-primary px-5 text-sm font-semibold text-white transition hover:bg-blue-dark">
                    Apply
                  </button>
                </form>
              </div>
...
const CartItem = ({ img, title, price }) => {
  return (
    <div className="mb-8 flex items-center border-b border-dashed border-white border-opacity-30 pb-8">
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-md border border-stroke bg-transparent px-5 py-3 text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
          />
          {carNumber && (
