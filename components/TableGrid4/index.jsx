    ...
    <section className="bg-gray-2 py-20 dark:bg-dark lg:py-[120px]">
      <div className="mx-auto px-4 sm:container">
        ...
        <div className="rounded-lg border border-stroke bg-white dark:border-dark-3 dark:bg-dark-2">
          <div className="flex flex-wrap [&>*:nth-child(3n)]:lg:border-r-0 [&>*:nth-child(4)]:lg:border-b-0 [&>*:nth-child(5)]:md:border-b-0">
            <TableGridItem
...
const TableGridItem = ({ image, price, link, title, review }) => {
  return (
    <div className="w-full border-stroke px-4 dark:border-dark-3 md:w-1/2 odd:md:border-r lg:w-1/3 even:lg:border-r [&:not(:last-child)]:border-b">
