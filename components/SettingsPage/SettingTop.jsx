  ...
  return (
    <div className='flex flex-wrap items-end justify-between sm:flex-nowrap sm:space-x-4 md:mb-6'>
      ...
      <div className='mb-6 flex items-center space-x-[18px]'>
        ...
        <button className='flex h-11 items-center justify-center rounded border border-transparent bg-primary px-6 text-base font-medium text-white hover:bg-opacity-90'>
          {button2}
        </button>
      </div>
    </div>
