    ...
    <div className='flex items-center px-6 py-3 mb-5 bg-white border rounded-md dark:bg-dark-2 dark:border-dark-3 border-stroke'>
      <div className='relative inline-block'>
        <select
          name=''
          id=''
          className='pr-12 text-base bg-transparent border-r outline-none appearance-none dark:text-dark-6 border-stroke dark:border-dark-3 text-body-color'
        >
      ...
      <div className='relative'>
        <input
          ...
          className='block w-full text-base bg-transparent outline-none dark:text-dark-6 pl-11 text-body-color'
        />
        ...
        <tr key={index}>
          ...
          <td className='px-5 py-3 border border-stroke !border-r-transparent dark:border-dark-3'>
            <div className='flex items-center justify-between'>
              <div className='relative mr-8 block h-[5px] w-full max-w-[280px] rounded bg-stroke dark:bg-dark-4'>
                <div
                  className={`absolute top-0 left-0 block h-full rounded bg-primary ${row.popularity}`}
                ></div>
              </div>
  ...
  return (
    <div className='items-center justify-between p-5 sm:flex sm:px-6'>
      ...
      <div className='flex items-center justify-end'>
        ...
        <button className='py-3 text-base font-medium text-white border border-transparent rounded-md bg-primary hover:bg-opacity-90 px-7 sm:text-base'>
          {buttonComplete}
        </button>
      </div>
    </div>
