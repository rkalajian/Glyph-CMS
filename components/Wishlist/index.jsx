              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="bg-white text-left">
                    <th
                      className={`last::xl:pr-9 min-w-[300px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9`}
                    >
                      Product
                    </th>
                    <th
                      className={`last::xl:pr-9 min-w-[90px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9`}
                    >
                      Price
                    </th>
                    <th
                      className={`last::xl:pr-9 min-w-[150px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9`}
                    >
                      Stoke Stats
                    </th>
                    <th
                      className={`last::xl:pr-9 min-w-[165px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9`}
                    >
                      Action
                    </th>
                    <th
                      className={`last::xl:pr-9 min-w-[140px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9`}
                    >
                      Remove
                    </th>
                  </tr>
  ...
  return (
    <tr>
      ...
      <td className="border-t p-4">
        <span
          className={`${
            stock ? "bg-secondary text-secondary" : "bg-danger text-danger"
          } inline-flex items-center justify-center rounded-full bg-opacity-[15%] px-4 py-2 text-xs font-semibold`}
        >
      ...
      <td className="border-t p-4">
        <button
          className={`${
            stock ? "bg-primary" : "bg-black"
          } inline-block rounded px-5 py-2 text-sm font-semibold text-white hover:bg-opacity-90`}
        >
          {button}
        </button>
      </td>
