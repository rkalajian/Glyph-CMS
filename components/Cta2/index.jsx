  ...
  return (
    <section className="bg-white py-20 dark:bg-dark lg:py-[120px]">
      <div className="container mx-auto">
        <div className="relative z-10 overflow-hidden rounded bg-primary px-8 py-12 md:py-20">
          <div className="-mx-4 flex">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[570px] text-center">
                ...
                <a
                  href="/#"
                  className="inline-block rounded-md bg-white px-7 py-4 text-base font-medium text-primary transition hover:bg-opacity-90"
                >
                  Get Pro Version
                </a>
              </div>
