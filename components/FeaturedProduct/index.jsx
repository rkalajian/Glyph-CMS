    ...
    <div className={`w-full px-4 ${big ? "lg:w-7/12" : "lg:w-5/12"}`}>
      <div className="group mb-10 overflow-hidden rounded-lg border border-stroke bg-white dark:border-dark-3 dark:bg-dark-2">
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 flex h-3/4 w-full items-end bg-gradient-to-t from-[#212C36B2] to-[#212B3600] p-8 opacity-0 transition-all group-hover:opacity-100">
            <div className="flex items-center space-x-3">
              <button className="flex h-9 w-9 items-center justify-center rounded bg-white text-center text-dark shadow-1 hover:bg-primary hover:text-white dark:bg-dark-2 dark:text-white dark:shadow-none">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
