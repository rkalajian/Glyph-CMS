              ...
              <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
                <form className="relative flex max-w-[180px] md:max-w-[230px] lg:max-w-[120px] xl:max-w-[230px]">
                  <input
                    ...
                    className="w-full rounded-full border border-white border-opacity-30 bg-transparent py-2 pl-5 pr-10 text-gray-7 outline-none focus:border-opacity-100 focus-visible:shadow-none"
                  />
