            ...
            <div className="text-center">
              ...
              <form className="space-y-4">
                <input
                  ...
                  className="h-[52px] w-full rounded-md border border-stroke bg-transparent px-6 text-center text-base text-body-color outline-none placeholder:opacity-60 focus:border-primary dark:border-dark-3 dark:text-dark-6"
                />
                <button className="h-[52px] w-full rounded-md bg-primary px-6 text-base font-medium text-white hover:bg-opacity-90">
                  Subscribe Now
                </button>
              </form>
            </div>
