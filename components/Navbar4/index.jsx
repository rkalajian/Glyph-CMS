                ...
                >
                  <form className="flex items-center justify-between">
                    <input
                      ...
                      className="w-full rounded-md border border-transparent bg-white py-4 pl-5 pr-8 text-body-color shadow-sm outline-none focus-visible:shadow-none dark:bg-dark-2 dark:text-white"
                    />
