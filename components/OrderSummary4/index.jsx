          ...
          <div className="flex flex-wrap items-center justify-between px-5 pt-6 sm:px-8 lg:px-11">
            <div className="order-last w-full md:order-first md:w-2/3 lg:w-1/2">
              <div className="flex flex-wrap pb-1">
                ...
                <button className="mb-5 flex items-center justify-center rounded-md bg-dark py-3 px-7 text-center text-base font-medium text-white hover:bg-opacity-90">
                  Cancel Order
                </button>
              </div>
            </div>
      ...
      <td className="border-stroke dark:border-dark-3 border-t py-6 pr-4 pl-5 sm:pl-8 lg:pl-11">
        <div className="flex items-center">
          <img
            src={img}
            alt="product"
            className="mr-6 h-16 w-16 rounded lg:h-20 lg:w-20"
          />
          <div>
            <a
              href={link}
