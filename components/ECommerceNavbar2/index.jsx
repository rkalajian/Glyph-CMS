                  ...
                  >
                    <form className="flex items-center justify-between">
                      <input
                        ...
                        className="w-full rounded-md border border-transparent bg-white py-4 pl-5 pr-8 text-body-color shadow-1 outline-none focus:border-primary focus-visible:shadow-none dark:bg-dark-2 dark:text-dark-6 dark:shadow-none"
                      />
      ...
      {dropdown && (
        <>
          <a
            ref={dropdownRef}
            href={NavLink}
            className="flex items-center justify-between rounded bg-gray-2 px-4 py-2 text-base font-medium text-dark hover:text-primary dark:bg-dark-2 dark:text-white lg:inline-flex lg:px-5 lg:py-2"
            onClick={() => {
          ...
          >
            ...
            <div className="group relative px-2 lg:px-6">
              ...
              <div
                ...
                } left-full top-0 border-stroke bg-white py-2 group-hover:visible group-hover:opacity-100 dark:border-dark-3 dark:bg-dark-2 lg:invisible lg:absolute lg:w-[600px] lg:rounded lg:border-[.5px] lg:px-8 lg:py-8 lg:opacity-0 xl:w-[650px]`}
              >
