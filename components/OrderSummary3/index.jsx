          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="mr-10 text-right md:ml-auto md:max-w-[370px] lg:max-w-[270px]">
                ...
                <button className="flex w-full items-center justify-center rounded-md bg-dark dark:bg-dark-2 py-[10px] px-10 text-center text-base font-semibold text-white hover:bg-opacity-90">
                  Continue Shopping
                </button>
              </div>
            </div>
  ...
  return (
    <div className="rounded-md border-[.5px] border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 py-5 pl-5 pr-8">
      <div className="items-center sm:flex">
        <div className="mb-3 mr-6 h-20 w-full max-w-[80px] sm:mb-0 rounded overflow-hidden">
          <img
            src={img}
            alt="product"
