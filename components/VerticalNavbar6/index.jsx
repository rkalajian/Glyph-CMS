          ...
          <div className="mt-2 p-8 pt-0">
            <form className="relative">
              <input
                ...
                className="h-11 w-full rounded border-[.5px] border-stroke bg-gray-2 pl-4 pr-9 text-sm font-medium text-black placeholder-body-color outline-none focus:border-primary"
              />
