        ...
        <div className="mx-auto w-full max-w-[510px] text-center">
          ...
          <form className="mb-5 flex flex-wrap items-center justify-center space-y-4 sm:flex-nowrap sm:justify-between sm:space-x-4 sm:space-y-0">
            <input
              ...
              className="w-full border border-stroke bg-white px-6 py-3 text-base text-body-color outline-none focus:border-primary"
            />
            <button className="w-full whitespace-nowrap border border-transparent bg-primary px-7 py-3 text-center text-base font-medium uppercase text-white hover:bg-opacity-90 sm:inline-block sm:w-auto">
              Sign up
            </button>
          </form>
