              ...
              <form>
                <div className="-mx-3 flex flex-wrap">
                  ...
                  <div className="w-full px-3">
                    <button
                      type="submit"
                      className="rounded-md border border-transparent bg-white px-7 py-3 text-base font-medium text-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
    ...
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-5">
        ...
        <input
          ...
          name={name}
          className="w-full rounded-md border border-white/20 bg-white/5 px-5 py-3 text-white placeholder-white/50 outline-none focus:border-white"
        />
      </div>
    </div>
  );
    ...
    <div className="w-full px-3">
      <div className="mb-8">
        ...
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none rounded-md border border-white/20 bg-white/5 px-5 py-3 text-white placeholder-white/50 outline-none focus:border-white"
