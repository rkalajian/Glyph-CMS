                ...
                <form>
                  ...
                  <div className="-mx-3 flex flex-wrap">
                    <div className="w-full px-3 md:w-1/2">
                      <button
                        type="submit"
                        className="mb-3 inline-flex h-[50px] w-full cursor-pointer items-center justify-center bg-primary px-5 font-medium text-white transition hover:bg-opacity-90"
                      >
                        Sign In
                      </button>
                    </div>
                    ...
                    <div className="w-full px-3 md:w-1/2">
                      <a
                        href="/#"
                        className="mb-3 inline-flex h-[50px] w-full cursor-pointer items-center justify-center bg-secondary px-5 font-medium text-white transition hover:bg-opacity-90"
                      >
                        Create Account
                      </a>
                    </div>
  ...
  return (
    <div>
      <input
        ...
        name={name}
        className="h-12 w-full border border-transparent bg-gray-2 bg-transparent px-5 text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark dark:text-white"
      />
    </div>
  );
};
