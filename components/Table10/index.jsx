      ...
      <div className='mb-4 w-full md:mb-0 md:max-w-[220px] lg:max-w-[415px]'>
        <div className='relative'>
          <input
            ...
            className='h-[50px] w-full rounded-lg border border-stroke dark:border-dark-3 dark:text-dark-6 bg-white dark:bg-dark pr-6 pl-14 text-base text-body-color outline-none focus:border-primary'
          />
