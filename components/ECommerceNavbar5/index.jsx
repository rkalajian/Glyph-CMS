    ...
    <li className={`${submenu && "group relative lg:py-4"}`}>
      ...
      {submenu && (
        <>
          ...
          >
            <span className="absolute -top-[6px] left-8 -z-10 hidden h-3 w-3 rotate-45 rounded-sm border-[.5px] border-b-0 border-r-0 border-stroke bg-white dark:border-dark-3 dark:bg-dark-2 lg:block xl:left-10"></span>
            {children}
          </div>
        </>
      )}
