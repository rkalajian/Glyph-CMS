          ...
          <div className='flex items-center sm:justify-end'>
            ...
            <div className='relative z-20 bg-white'>
              <select
                name='sorting'
                id='sorting'
                className='relative z-20 inline-block appearance-none rounded border border-stroke bg-transparent py-2 pl-5 pr-10 outline-none'
              >
    ...
    <tr>
      <td className='min-w-[375px] py-[15px] pl-7 pr-3'>
        <div className='flex items-center'>
          <div className='mr-[18px] h-[70px] w-full max-w-[70px] rounded'>
