  ...
  return (
    <div>
      ...
      <input
        ...
        name={name}
        className="w-full rounded-md border border-stroke bg-gray-2 px-5 py-3 text-base text-body-color outline-none focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-white"
      />
    </div>
  );
};
