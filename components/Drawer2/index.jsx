...
const CartItem = ({ img, link, name, color, price }) => {
  ...
  return (
    <div className="flex w-full">
      <div className="mr-5 h-[86px] w-full max-w-[70px] overflow-hidden rounded sm:max-w-[86px]">
        <img
          src={img}
          alt="product"
      ...
      <div className="w-full">
        ...
        <div className="flex justify-between">
          <div className="inline-flex items-center rounded border border-stroke text-sm font-medium text-dark dark:border-dark-3 dark:text-white">
            <span
              onClick={decrease}
