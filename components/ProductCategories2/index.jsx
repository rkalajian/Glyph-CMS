  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      <div className="relative z-10 mb-10">
        ...
        <div className="absolute bottom-0 left-0 flex h-3/4 w-full items-end justify-center bg-gradient-to-b from-[#3056D300] to-[#3056D3E5] py-10 px-5">
          <div className="text-center">
            <a
              href={link}
              className="mb-2 block text-xl font-bold text-white hover:text-opacity-80 sm:text-2xl xl:leading-10 xl:text-[28px]"
            >
              {title}
            </a>
