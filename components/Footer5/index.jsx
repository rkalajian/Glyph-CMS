                ...
                <form className="flex flex-wrap">
                  <div className="relative mb-3 mr-5 w-full max-w-[370px]">
                    <input
                      ...
                      className="h-[52px] w-full rounded border border-white/[.08] bg-white/5 pl-14 pr-5 text-dark-6 outline-none focus:border-primary focus-visible:shadow-none"
                    />
                  ...
                  <button
                    type="submit"
                    className="mb-3 h-[52px] rounded border border-transparent bg-primary px-7 text-white transition hover:bg-opacity-90"
                  >
                    Subscribe
                  </button>
                </form>
