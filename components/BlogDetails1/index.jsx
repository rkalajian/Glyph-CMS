        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-10/12 xl:w-8/12">
            <div className="w-full">
              ...
              <div className="overflow-hidden rounded py-10">
                <img
              ...
              <div className="relative z-10 mb-10 overflow-hidden rounded bg-primary p-10 text-center md:px-[60px]">
  ...
  return (
    <div className={`${isReply ? 'ml-16 flex pb-11 md:ml-[110px]' : 'flex pb-11 lg:mr-16 xl:mr-[80px]'}`}>
        ...
        <div className="w-full">
          ...
          <button
            className="px-5 py-2 text-xs font-medium rounded bg-primary/5 text-primary hover:bg-primary hover:text-white"
          >
            Reply
          </button>
        </div>
  ...
  return (
    <div className="mb-9">
      ...
      <input
        ...
        className="w-full rounded border border-stroke dark:border-dark-3 dark:bg-dark bg-white py-3 px-[14px] text-body-color outline-none dark:text-dark-6 focus:border-primary"
      />
    </div>
  );
};
  ...
  return (
    <div className="mb-12">
      ...
      <textarea
        rows="7"
        placeholder={placeholder}
        className="w-full resize-none rounded border border-stroke dark:border-dark-3 dark:bg-dark bg-white py-3 px-[14px] text-body-color outline-none dark:text-dark-6 focus:border-primary"
      ></textarea>
    </div>
  );
};