      ...
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[970px]">
          <div className="relative h-[130px] md:h-[260px]">
            ...
            <label
              htmlFor="cover"
              className="absolute bottom-4 right-4 z-10 inline-flex cursor-pointer items-center justify-center rounded bg-primary px-4 py-1 text-sm font-medium text-white hover:bg-opacity-90"
            >
          ...
          <div className="relative">
            <div className="relative z-10 mx-auto -mt-[60px] h-[120px] w-full max-w-[120px] rounded-full p-2 md:-mt-[86px] md:h-[176px] md:max-w-[176px]">
              <div className="absolute left-0 top-0 -z-10 h-full w-full overflow-hidden rounded-full bg-white/20 backdrop-blur"></div>
              <img
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-3 right-3 z-40 flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90"
              >
                <input
                  type="file"
                  name="profile"
          ...
          <div className="mt-3 text-center">
            ...
            <div className="-mx-[18px] mb-5 inline-flex rounded bg-white py-[10px] shadow-profile-5 dark:bg-dark-2">
