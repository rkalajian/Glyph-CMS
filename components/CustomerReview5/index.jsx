  ...
  return (
    <div className={`${replyItem && "pt-11"}`}>
      ...
      <div>
        ...
        <button className="inline-flex items-center justify-center rounded bg-primary px-5 py-[5px] text-center text-base font-medium text-white hover:bg-blue-dark">
          Reply
        </button>
      </div>
    </div>
  ...
  return (
    <div className="mb-6">
      <textarea
        rows={row}
        placeholder={placeholder}
        className="w-full rounded-md border border-stroke bg-transparent px-5 py-5 text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
      ></textarea>
    </div>
  );
};
