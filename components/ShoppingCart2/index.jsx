          ...
          <div className="flex flex-wrap justify-between">
            <div className="mb-10 ml-auto w-full md:mb-0 md:ml-0 md:max-w-[300px] lg:max-w-[360px]">
              <form className="relative">
                <input
                  ...
                  className="w-full border border-form-stroke px-6 py-[14px] font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"
                />
                <button className="absolute right-3 top-1/2 mb-3 h-[34px] -translate-y-1/2 bg-primary px-5 text-sm font-medium text-white transition hover:bg-opacity-90">
                  Apply
                </button>
              </form>
            </div>
            <div className="ml-auto px-6 xl:pr-10">
              <div className="ml-auto w-full max-w-[320px]">
                ...
                <button className="mb-4 flex w-full justify-center bg-primary px-5 py-[10px] text-sm font-semibold text-white transition hover:bg-opacity-90">
                  Checkout
                </button>
          ...
          <div className="w-full items-end justify-between sm:flex">
            <div className="mb-5">
              ...
              <div className="relative">
                <select className="w-full appearance-none border border-form-stroke py-2 pl-4 pr-7 text-sm font-semibold text-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]">
