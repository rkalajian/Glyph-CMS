              ...
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-4 inline-block sm:mb-0">
                  <div className="relative">
                    <select className="w-full appearance-none rounded-[5px] border border-stroke bg-transparent py-[9px] pl-[18px] pr-10 font-medium text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-white">
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div className="mb-8 flex h-full items-center justify-center rounded-lg border border-dashed border-stroke py-12 dark:border-dark-3">
                <span className="text-3xl font-semibold text-dark text-opacity-10 dark:text-white md:text-[44px] md:leading-tight">
                  Products
                </span>
              </div>
            </div>
