    ...
    <div className="w-full px-4 md:w-1/2">
      <div className="mb-7 lg:mb-9">
        ...
        <input
          ...
          name={name}
          className="w-full rounded border border-stroke bg-white px-[14px] py-3 text-base leading-relaxed text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark dark:text-dark-6 md:px-[18px] md:py-4"
        />
      </div>
    </div>
  );
    ...
    <div className="w-full px-4">
      <div className="mb-7 lg:mb-9">
        ...
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none rounded border border-stroke bg-white px-[14px] py-3 text-base leading-relaxed text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark dark:text-dark-6 md:px-[18px] md:py-4"
