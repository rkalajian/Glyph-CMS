                    ...
                    <div className="items-center lg:flex">
                      ...
                      <div className="w-full px-4 sm:px-8 pb-8 lg:pt-8 xl:pl-[70px] xl:pr-[70px]">
                        ...
                        <div className="flex flex-wrap gap-[18px]">
                          <div>
                            <button className="inline-flex items-center justify-center bg-dark py-[13px] px-7 text-center text-base font-medium text-white hover:bg-opacity-90 md:px-10">
                              Add to Cart
                            </button>
                          </div>
                          <div>
