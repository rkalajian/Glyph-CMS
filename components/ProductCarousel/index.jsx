  ...
  return (
    <div>
      <div className="relative mb-5 overflow-hidden rounded-md">
        ...
        {newItem && (
          <span className="absolute right-4 top-4 inline-flex items-center justify-center rounded bg-secondary pl-[10px] pr-2 py-[3px] text-sm font-medium text-white">
            New
            <span className="pl-1">
              <svg
                width="12"
        ...
        {hotItem && (
          <span className="absolute right-4 top-4 inline-flex items-center justify-center rounded bg-red-600 pl-[10px] pr-2 py-[3px] text-sm font-medium text-white">
            Hot
            <span className="pl-1">
              <svg
                width="14"
