  ...
  return (
    <div className="mb-6">
      <input
        ...
        name={name}
        className="w-full border-b border-stroke bg-transparent py-[10px] text-base font-medium text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-white"
      />
    </div>
  );
};
