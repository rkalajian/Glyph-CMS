    ...
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="relative mb-10 overflow-hidden rounded-lg">
          ...
          />
          <div
            className={`from-${bgColor} xs:px-8 absolute left-0 top-0 flex h-full w-full items-end justify-between rounded-md bg-gradient-to-tr to-transparent py-8 px-5 md:px-5 xl:px-8`}
          >
