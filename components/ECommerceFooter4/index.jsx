            ...
            <div className="w-full px-4 md:w-1/2 lg:w-6/12 xl:w-3/12">
              <div className="mb-16">
                ...
                <div className="sm:flex md:block lg:flex xl:block">
                  ...
                  <a
                    href="/#"
                    className="mb-3 mr-3 flex w-full max-w-[230px] items-center rounded-[5px] bg-dark px-[22px] py-2 hover:bg-opacity-90 dark:bg-dark-2"
                  >
...
const FooterTopItem = ({ icon, title, subtitle }) => {
  return (
    <div className="w-full border-stroke px-4 dark:border-dark-3 md:w-1/3 even:md:border-x">
