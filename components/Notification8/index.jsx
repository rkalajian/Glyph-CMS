    ...
    <section className="bg-gray-2 dark:bg-dark py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="flex justify-end">
          <div className="shadow-1 dark:shadow-box-dark relative flex w-full max-w-[460px] items-center overflow-hidden rounded-lg bg-white dark:bg-dark-2 py-[18px] px-5">
            <span className="bg-stroke dark:bg-dark-3 absolute left-0 bottom-0 block h-[3px] w-full">
              <span className="w-3/4 h-full bg-primary absolute left-0 top-0"></span>
            </span>
            <span className="mr-4 max-w-[30px] w-full h-[30px] rounded-full border border-primary flex items-center justify-center">
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
            ...
            <button className="text-dark-5 dark:text-dark-6 hover:text-primary absolute right-5 top-1/2 -translate-y-1/2">
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
