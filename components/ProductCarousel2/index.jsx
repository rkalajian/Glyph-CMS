  ...
  return (
    <div className="shadow-1 dark:shadow-box-dark mb-10 overflow-hidden rounded-lg bg-white dark:bg-dark-2">
      <div className="relative">
        ...
        {discountedPrice && (
          <span className="bg-primary absolute left-6 top-4 inline-flex items-center justify-center rounded px-[10px] py-[3px] text-sm font-medium text-white">
            -50%
          </span>
        )}
        {newItem && (
          <span className="bg-secondary absolute left-6 top-4 inline-flex items-center justify-center rounded px-[10px] py-[3px] text-sm font-medium text-white">
            New
          </span>
        )}
        {hotItem && (
          <span className="absolute left-6 top-4 inline-flex items-center justify-center rounded bg-red-600 px-[10px] py-[3px] text-sm font-medium text-white">
            Hot
          </span>
        )}
      </div>
