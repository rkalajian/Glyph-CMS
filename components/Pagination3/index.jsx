  ...
  return (
    <section className="py-20 dark:bg-dark">
      <div className="text-center">
        <div className="mb-12 inline-flex rounded bg-white p-3 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.13)] dark:bg-dark-2">
          <ul className="-mx-[6px] flex items-center">
            ...
            <PageLink count="..." pageSrc="/#" />
            <PageLink count="10" pageSrc="/#" />
