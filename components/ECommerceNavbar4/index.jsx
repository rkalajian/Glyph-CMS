                ...
                <div className="-mx-3 hidden items-center justify-end md:flex">
                  <div className="px-3">
                    <div className="relative">
                      <select className="w-full appearance-none rounded-lg bg-transparent py-3 pl-3 pr-5 text-sm font-medium text-body-color outline-none transition dark:text-dark-6">
            ...
            <div className="hidden w-full lg:flex">
              <form className="relative flex w-full items-center rounded-md border border-stroke bg-gray-2 dark:border-dark-3 dark:bg-dark-2">
                ...
                <input
                  ...
                  className="w-full bg-transparent py-3 pl-6 pr-[58px] text-base text-body-color outline-none dark:text-dark-6"
                />
