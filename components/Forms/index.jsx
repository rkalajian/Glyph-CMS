      ...
      {type === "submit" ? (
        <div className="mb-10">
          <input
            ...
            name={name}
            value={defaultValue}
            className={`bordder-primary w-full cursor-pointer rounded-md border px-5 py-3 text-base text-white transition bg-${bgColor} hover:bg-opacity-90`}
          />
        </div>
      ) : (
        <div className="mb-6">
          <input
            ...
            name={name}
            value={defaultValue}
            className="bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] px-5 py-3 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none"
          />
        </div>
      )}
    </>
