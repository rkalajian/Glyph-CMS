    ...
    <div className="w-full px-4">
      <div className="-mx-4 mb-12 flex flex-wrap items-center">
        <div className="w-full px-4 lg:w-6/12 xl:w-6/12">
          <div className="mb-8 w-full overflow-hidden rounded lg:mb-0">
            <img src={image} alt="image" className="w-full" />
          </div>
        </div>
        <div className="w-full px-4 lg:w-6/12 xl:w-6/12">
          <div className="w-full">
            <span className="mb-8 inline-block rounded bg-primary px-5 py-3 text-sm font-semibold text-white">
              {metaText}
            </span>
