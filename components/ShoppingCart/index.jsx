      ...
      <section className="overflow-x-hidden">
        <div className="container mx-auto py-14 text-center">
          <button
            ...
            className="bg-primary rounded-md py-3 px-8 text-base font-semibold text-white hover:bg-opacity-90"
          >
            Open Modal
          </button>
        </div>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center justify-end">
              ...
              <button className="bg-primary inline-flex items-center justify-center rounded py-[10px] px-7 text-center text-base font-semibold text-white hover:bg-opacity-90">
                Checkout
              </button>
            </div>
          </div>
  ...
  return (
    <div className="flex justify-between border-b border-[#e7e7e7] pb-8">
      <div className="flex items-center">
        <div className="xs:h-[100px] xs:max-w-[100px] mr-5 h-[90px] w-full max-w-[80px] overflow-hidden rounded">
          <img
            src={img}
            alt="product"
        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            <button className="hover:border-primary hover:bg-primary rounded border border-black px-4 py-1 text-sm font-medium text-black transition hover:text-white">
              {button}
            </button>
            <button className="hover:border-danger hover:bg-danger rounded border border-black px-4 py-1 text-sm font-medium text-black transition hover:text-white">
              {button2}
            </button>
          </div>
        </div>
