  ...
  return (
    <section className="bg-gray-2 dark:bg-dark py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="relative flex max-w-[422px] items-center rounded-lg border border-green-light-4 dark:border-green bg-white dark:bg-dark-2 p-5">
          ...
          <div className="flex w-full items-center justify-between">
            <div>
              <h6 className="text-base font-semibold text-dark dark:text-white sm:text-lg mb-0.5">
                Success
              </h6>
            ...
            <button className="text-dark-5 dark:text-dark-6 hover:text-green">
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
