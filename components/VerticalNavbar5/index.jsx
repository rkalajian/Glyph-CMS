  ...
  return (
    <li className="relative">
      <a
        ...
        className={`${
          dropdownOpen ? "bg-white bg-opacity-[15%] text-opacity-100" : ""
        } relative mb-[2px] flex items-center rounded py-[10px] px-4 text-base font-medium text-white text-opacity-50 duration-200 hover:bg-white hover:bg-opacity-[15%] hover:text-opacity-100`}
      >
