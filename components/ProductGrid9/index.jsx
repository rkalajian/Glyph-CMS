  ...
  return (
    <div className="mx-auto flex w-full max-w-[870px] flex-wrap items-center rounded-md border border-stroke bg-white p-5 dark:border-dark-3 dark:bg-dark-2 sm:flex-nowrap">
      <div className="relative mb-5 w-full overflow-hidden rounded-md sm:mb-0 sm:max-w-[270px]">
        ...
        {newItem && (
          <span className="absolute right-4 top-4 inline-flex items-center justify-center rounded bg-secondary px-3 py-1 text-sm font-semibold text-white">
            New
            <span className="pl-1">
              <svg
                width="12"
        ...
        <div className="absolute bottom-7 left-0 right-0 mx-auto flex w-full items-center justify-center space-x-3">
          <div className="group relative">
            ...
            <div className="absolute -top-full left-1/2 z-50 mb-10 -translate-x-1/2 whitespace-nowrap rounded bg-white px-2 py-2 text-sm font-semibold text-dark opacity-0 group-hover:opacity-100 dark:bg-dark dark:text-white">
