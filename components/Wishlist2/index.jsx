            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="border-t text-left">
                  <th
                    className={`min-w-[300px] text-dark py-4 px-4 text-base font-medium first:xl:pl-11 last:xl:pr-11`}
                  >
                    {" "}
                    Product Name{" "}
                  </th>
                  <th
                    className={`min-w-[180px] text-dark py-4 px-4 text-base font-medium first:xl:pl-11 last:xl:pr-11`}
                  >
                    {" "}
                    Unit Price{" "}
                  </th>
                  <th
                    className={`min-w-[140px] text-dark py-4 px-4 text-base font-medium first:xl:pl-11 last:xl:pr-11`}
                  >
                    {" "}
                    Stock Status{" "}
                  </th>
                  <th
                    className={`min-w-[150px] text-dark py-4 px-4 text-base font-medium first:xl:pl-11 last:xl:pr-11`}
                  >
                    {" "}
                    Action{" "}
                  </th>
...
const TableDataRow = ({
  ...
  return (
    <tr>
      ...
      <td className="border-t p-4">
        <button className="bg-primary inline-block rounded-full py-1 px-5 text-sm font-medium text-white hover:bg-opacity-90">
          {button}
        </button>
      </td>
