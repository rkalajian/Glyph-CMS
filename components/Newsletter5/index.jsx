                ...
                <div className="px-8 py-9 sm:px-14 sm:py-12 md:px-8 lg:px-12 lg:py-14 xl:px-[60px]">
                  ...
                  <form className="mb-5 space-y-4">
                    <input
                      ...
                      className="h-[52px] w-full border border-stroke bg-transparent px-6 text-center text-base text-body-color outline-none placeholder:opacity-50 focus:border-primary dark:border-dark-3 dark:text-dark-6"
                    />
                    <button className="h-[52px] w-full border border-transparent bg-primary px-6 text-base font-medium text-white hover:bg-opacity-90">
                      Subscribe Now
                    </button>
                  </form>
