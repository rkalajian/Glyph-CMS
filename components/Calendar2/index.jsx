          ...
          <div className="mb-[30px] flex items-center justify-between rounded-lg border border-stroke bg-gray-2 py-3 pl-[30px] pr-4 dark:border-dark-3 dark:bg-dark-2">
            ...
            <div className="relative z-20 inline-flex rounded-[5px] bg-white dark:bg-dark">
              <select
                name=""
                id=""
                className="relative z-20 h-11 appearance-none rounded-[5px] border border-stroke bg-transparent pl-5 pr-10 text-dark outline-none dark:border-dark-3 dark:text-white"
              >
      ...
      <div className="mx-auto flex h-24 w-10 flex-col overflow-hidden sm:w-full md:h-40 md:w-20 lg:w-28 2xl:w-40">
        ...
        {active && (
          <div className="bottom md:h-30 group h-16 w-full flex-grow cursor-pointer py-1">
            ...
            <div className="event invisible absolute left-2 z-10 mb-1 w-[200%] rounded border-l-[3px] border-primary bg-gray-2 px-[18px] py-[6px] text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-dark md:visible md:w-[190%] md:opacity-100">
