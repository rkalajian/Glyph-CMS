...
const TableTop = () => {
  return (
    <div className='items-center justify-between space-y-4 border-b border-stroke dark:border-dark-3 py-[18px] px-5 sm:flex sm:space-x-4 sm:space-y-0'>
      <div className='w-full md:max-w-[420px]'>
        <div className='relative overflow-hidden rounded'>
          <input
            ...
            className='h-[46px] w-full rounded-md dark:border-dark-3 border bg-transparent dark:text-dark-6 placeholder:opacity-60 border-stroke pl-5 pr-14 text-base text-body-color outline-none focus:border-primary'
          />
      ...
      <div>
        <button className='flex h-[46px] items-center justify-center whitespace-nowrap rounded-md bg-primary px-6 text-base font-medium text-white hover:bg-opacity-90'>
          <span className='mr-2'>
            <svg
              width={20}
              height={20}
