                    ...
                    <div className="lg:max-w-[300px]">
                      ...
                      <form className="relative">
                        <input
                          ...
                          className="w-full rounded-[5px] border border-stroke bg-transparent py-3 pl-5 pr-20 text-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
                        />
                        <button className="absolute right-2 top-1/2 mb-3 h-[34px] -translate-y-1/2 rounded bg-dark px-5 text-sm font-medium text-white transition hover:bg-opacity-90">
                          Apply
                        </button>
                      </form>
                    </div>
    ...
    <tr>
      <td className="border-t border-stroke p-4 dark:border-dark-3 xl:pl-11">
        <div className="flex items-center">
          <img src={img} alt="image" className="mr-4 h-12 w-12 rounded" />
          <div>
      ...
      <td className="border-t border-stroke p-4 dark:border-dark-3">
        <div className="inline-flex h-9 items-center rounded border-[0.5px] border-stroke bg-gray-1 text-base font-medium text-dark dark:border-dark-3 dark:bg-dark dark:text-white">
          <span
    ...
    <div className="mb-4">
      ...
      >
        <div className="relative">
          ...
          <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded-full border border-primary bg-primary bg-opacity-5">
  ...
  return (
    <div className="mb-5">
      ...
      <input
        ...
        className="w-full rounded-md border border-stroke bg-transparent px-5 py-3 text-body-color outline-none focus:border-primary dark:border-dark-3 dark:text-dark-6"
      />
    </div>
  );
};
