                        ...
                        <Swiper slidesPerView={1} loop={true} ref={sliderRef}>
                          ...
                          <div className="z-50 absolute top-1/2 right-5 left-5 flex -translate-y-1/2 items-center justify-between">
                            <div
                              ...
                              onClick={handlePrev}
                            >
                              <button className="flex h-8 w-8 items-center justify-center rounded bg-dark text-white transition-all hover:bg-primary hover:text-white">
                                <svg
                                  width={20}
                                  height={20}
                                  viewBox="0 0 20 20"
                        ...
                        <div className="lg:ml-9 xl:ml-11 text-left">
                          ...
                          <div className="mb-[22px]">
                            ...
                            <div className="flex items-center gap-3">
                              <div>
                                ...
                                <label
                                  htmlFor="small"
                                  className="inline-block cursor-pointer rounded border border-stroke dark:border-dark-3 py-1 px-[15px] text-base font-medium text-dark dark:text-white hover:border-primary hover:bg-primary hover:text-white"
                                >
                                  S
                                </label>
                              </div>
                          ...
                          <div className="mb-8">
                            ...
                            <div className="flex items-center gap-3">
                              <div>
                                ...
                                <label
                                  htmlFor="black"
                                  className="box flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded bg-[#56768B] text-white"
                                >
                              ...
                              <div>
                                ...
                                <label
                                  htmlFor="red"
                                  className="box flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded bg-red-600 text-white"
                                >
                                  <span className="opacity-0">
                                    <svg
                                      width={20}
                              ...
                              <div>
                                ...
                                <label
                                  htmlFor="blue"
                                  className="box flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded bg-primary text-white"
                                >
                                  <span className="opacity-0">
                                    <svg
                                      width={20}
                              ...
                              <div>
                                ...
                                <label
                                  htmlFor="green"
                                  className="box flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded bg-secondary text-white"
                                >
                                  <span className="opacity-0">
                                    <svg
                                      width={20}
                          ...
                          <div className="flex flex-wrap gap-4">
                            ...
                            <div>
                              <a
                                href="/#"
                                className="inline-flex items-center justify-center rounded-md bg-dark py-3 px-7 text-center text-base font-medium text-white hover:bg-opacity-90"
                              >
                                View Details
                              </a>
                            </div>
