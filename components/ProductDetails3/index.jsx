    ...
    <>
      <section className="bg-white py-20 lg:py-[120px] dark:bg-dark">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-5/12">
              ...
              <div className="mb-8 pt-2">
                <button className="flex w-full items-center justify-center bg-dark-2 py-3 px-10 text-center text-base font-medium text-white hover:bg-opacity-90">
                  Add to Beg
                </button>
              </div>
          ...
          <div
            className={`fixed top-0 left-0 z-20 flex h-full w-full items-center justify-center bg-black bg-opacity-50 py-10 ${
              !open && "hidden"
            } `}
          >
            <div
