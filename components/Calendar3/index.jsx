      ...
      <section className="relative z-10 bg-gray-2 py-[120px] dark:bg-dark">
        <div className="mx-auto px-4 lg:container">
          <div className="relative mx-auto mb-5 w-full max-w-[370px]">
            <input
              type="date"
              className="custom-input-date h-[50px] w-full appearance-none rounded-md border border-stroke bg-white px-5 text-secondary-color outline-none focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6"
            />
          ...
          <div className="relative mx-auto w-full max-w-[370px] rounded border border-stroke bg-white p-6 shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark sm:p-[30px]">
            <div className="mb-3 flex items-center space-x-5">
              <div className="relative inline-flex">
                <select
                  name=""
                  id=""
                  className="appearance-none bg-transparent pr-5 text-base font-medium text-dark outline-none dark:text-white"
                >
              ...
              <div className="relative inline-flex">
                <select
                  name=""
                  id=""
                  className="appearance-none bg-transparent pr-7 text-base font-medium text-dark outline-none dark:text-white"
                >
                  <option value="" className="dark:bg-dark-2">
                    2023
                  </option>
