      ...
      <div className="mb-10">
        ...
        <div>
          ...
          <div className="space-y-3">
            <a
              href={link}
              className="flex w-full items-center justify-center border border-transparent bg-primary px-10 py-2 text-center text-sm font-semibold text-white hover:bg-opacity-90"
            >
              {button}
            </a>
            <a
