...
const SingleProduct = ({ img, link, title, price, reviews }) => {
  return (
    <div className="odd:md-border-r w-full border-[#e7e7e7] px-4 dark:border-dark-3 md:w-1/2 lg:w-1/3 lg:border-r [&:not(:last-child)]:border-b [&:nth-child(2n)]:lg:border-r">
