    ...
    <section className="bg-gray-2 dark:bg-dark py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="flex justify-end">
          <div className="border-primary bg-primary/5 relative flex w-full max-w-[460px] items-center rounded-lg border py-[18px] px-5">
            <span className="mr-4 max-w-[30px] w-full h-[30px] rounded-full bg-primary flex items-center justify-center">
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
