  ...
  return (
    <div className="flex items-center">
      ...
      <label htmlFor={name} className="flex w-full items-center">
        ...
        >
          <div className={`box mr-5 flex h-5 w-full max-w-[20px] cursor-pointer items-center justify-center rounded border  ${isChecked ? "border-primary bg-primary" : "border-stroke dark:border-dark-3"}`}>
