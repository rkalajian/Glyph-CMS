      ...
      <div className="flex h-screen w-[300px] flex-col justify-between overflow-y-auto bg-[#212B36]">
        ...
        <div className="border-t border-[#E7E7E733] p-[30px] pb-10">
          <form className="relative mb-6">
            <input
              type="text"
              className="placeholder-body-color h-10 w-full rounded border-[.5px] border-[#E7E7E730] bg-white bg-opacity-10 pl-10 pr-3 text-sm font-medium text-white outline-none focus:border-white focus:bg-transparent"
              placeholder="Search"
            />
  ...
  return (
    <li className="relative">
      <a
        ...
        className={`${
          dropdownOpen ? "bg-white bg-opacity-10 text-opacity-100" : ""
        } relative flex w-full items-center rounded py-[10px] px-[15px] text-base font-medium text-white text-opacity-50 hover:bg-white hover:bg-opacity-10 hover:text-opacity-100`}
      >
