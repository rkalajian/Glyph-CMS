    ...
    <div className='px-6 py-4 mb-5 bg-white rounded-md dark:bg-dark-2 shadow-2'>
      <div className='relative'>
        <input
          ...
          className='block w-full text-base bg-transparent outline-none placeholder:opacity-60 px-7 text-body-color dark:text-dark-6'
        />
  ...
  return (
    <div className='flex items-center justify-between p-5 mt-2 border-t sm:px-6 border-stroke dark:border-dark-3'>
      ...
      <div className='flex items-center justify-end space-x-3'>
        <button className='flex h-[30px] w-[30px] items-center justify-center rounded border border-stroke bg-[#FAFBFF] text-body-color dark:border-dark-3 dark:bg-dark dark:text-dark-6 hover:border-primary hover:bg-primary hover:text-white'>
          <svg
            width='18'
            height='18'
            viewBox='0 0 18 18'
