                  ...
                  <div className="w-full px-4 md:w-3/12 lg:w-3/12 xl:w-4/12">
                    <div className="flex items-center space-x-4 md:justify-end">
                      <div>
                        ...
                        <label
                          htmlFor="1"
                          className={`flex h-10 w-10 cursor-pointer items-center justify-center rounded border border-stroke bg-white text-body-color peer-checked:border-primary peer-checked:bg-primary peer-checked:text-white dark:border-dark-3 dark:bg-white/5 dark:text-dark-6`}
                        >
                          <svg
...
const CheckboxGroup = ({ title, id }) => {
  return (
    <div className="mb-3 mr-3">
      ...
      <label
        htmlFor={id}
        className="block cursor-pointer rounded border border-stroke bg-white px-3 py-1 text-base font-medium text-body-color hover:border-primary hover:bg-primary hover:text-white peer-checked:border-primary peer-checked:bg-primary peer-checked:text-white dark:border-dark-3 dark:bg-white/5 dark:text-dark-6"
      >
        {title}
      </label>
    </div>
