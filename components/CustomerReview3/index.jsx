  ...
  return (
    <div className="mb-6">
      <input
        ...
        className="w-full rounded-lg border border-stroke bg-transparent px-5 py-3 text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
      />
    </div>
  );
};
  ...
  return (
    <div className="mb-6">
      <textarea
        rows={row}
        placeholder={placeholder}
        className="w-full rounded-lg border border-stroke bg-transparent px-5 py-5 text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
      ></textarea>
    </div>
  );
};
