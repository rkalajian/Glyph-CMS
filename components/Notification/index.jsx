  ...
  return (
    <section className="bg-gray-2 dark:bg-dark py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="border-stroke dark:border-dark-3 shadow-1 dark:shadow-box-dark relative flex max-w-[415px] items-center rounded-lg border bg-white dark:bg-dark-2 px-5 py-4">
          <button className="hover:text-red absolute top-3 right-3 text-dark-5 dark:text-dark-6">
            <svg
              width={14}
              height={14}
              viewBox="0 0 14 14"
