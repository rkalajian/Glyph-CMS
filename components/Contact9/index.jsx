            ...
            <div className="w-full lg:w-7/12">
              <div className="relative flex h-full w-full overflow-hidden">
                ...
                <div className="absolute bottom-14 left-0 right-0 mx-auto w-full max-w-[560px] px-5">
                  <div className="w-full flex-wrap items-center rounded bg-white px-4 py-9 shadow-[0px_4px_10px_0px_rgba(0,0,0,0.25)] dark:bg-dark-2 md:inline-flex md:px-4 lg:px-0 xl:px-4">
              ...
              <div className="2xl:px-70 w-full px-8 py-14 sm:p-[70px] lg:px-14">
                ...
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="cursor-pointer rounded-md border border-transparent bg-primary px-7 py-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
  ...
  return (
    <div className="mb-5">
      ...
      <input
        ...
        name={name}
        className="w-full rounded-md border border-stroke bg-transparent px-5 py-3 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
      />
    </div>
  );
};
    ...
    <>
      <div className="mb-6">
        ...
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none rounded-md border border-stroke bg-transparent px-5 py-3 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
