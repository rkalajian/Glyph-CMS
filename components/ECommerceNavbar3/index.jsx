                ...
                <div className="-mx-3 hidden items-center md:flex">
                  <div className="px-3">
                    <div className="relative flex items-center">
                      ...
                      <select className="w-full appearance-none rounded-lg bg-transparent py-3 pl-2 pr-4 text-base font-medium text-white outline-none transition">
...
const TopNavItem = ({ link, name }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block px-[10px] py-4 text-base font-medium text-white hover:text-opacity-90"
      >
        {name}
      </a>
    </li>
            ...
            <div className="hidden w-full lg:flex">
              <form className="relative flex w-full items-center rounded-md bg-white dark:bg-dark-2">
                <div className="relative border-r border-stroke dark:border-dark-3">
                  <select className="appearance-none bg-transparent py-[14px] pl-[22px] pr-10 text-base font-medium text-dark outline-none dark:text-white">
                ...
                <input
                  ...
                  className="w-full bg-transparent py-[14px] pl-6 pr-[58px] text-base text-body-color outline-none dark:text-dark-6"
                />
...
const SubmenuItem = ({ link, name }) => {
  return (
    <a
      href={link}
      className="block rounded py-2 text-sm font-medium text-white hover:opacity-90"
    >
      {name}
    </a>
  );
