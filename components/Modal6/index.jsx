        ...
        >
          ...
          <form className="relative">
            <input
              ...
              className="h-12 w-full rounded border border-stroke bg-transparent pl-[46px] pr-[86px] text-base text-dark placeholder-body-color outline-none focus:border-primary dark:border-dark-3 dark:text-white"
            />
            ...
            <button className="absolute right-[10px] top-1/2 h-[30px] -translate-y-1/2 rounded bg-primary px-5 text-sm font-medium text-white hover:bg-opacity-90">
              Copy
            </button>
          </form>
        </div>
