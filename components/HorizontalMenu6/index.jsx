          ...
          <div className="flex w-full items-center justify-between">
            <div className="mr-4 flex items-center">
              <div className="group relative mr-4">
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded bg-white bg-opacity-[8%] text-white"
                >
                  <svg
                    width="21"
                    height="20"
              ...
              <div className="relative mr-11 hidden w-full max-w-[250px] lg:block">
                <input
                  type="text"
                  placeholder="Search..."
                  className="h-9 w-full rounded border border-transparent bg-white/[0.08] pl-10 pr-4 text-sm font-medium text-white/50 outline-none focus:border-white"
                />
            ...
            <div className="flex items-center justify-end">
              ...
              <div className="group relative">
                ...
                <div className="invisible absolute right-0 top-[120%] mt-3 w-[200px] space-y-2 rounded bg-white p-3 opacity-0 shadow-card-2 duration-200 group-hover:visible group-hover:top-full group-hover:opacity-100 dark:bg-dark-2">
