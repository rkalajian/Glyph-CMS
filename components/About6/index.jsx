  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[110px]">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 lg:w-1/2">
              <div className="bg-primary relative z-10 mb-12 py-12 px-5 sm:px-12 lg:mb-0 2xl:p-[70px]">
                ...
                <p className="mb-6 text-base leading-relaxed text-white text-opacity-70">
                ...
                <p className="mb-8 text-base leading-relaxed text-white text-opacity-70">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="flex items-center justify-center w-full h-full">
                ...
                >
                  <span className="absolute top-0 right-0 z-[-1] h-full w-full animate-ping rounded-full bg-white bg-opacity-25 delay-300 duration-1000"></span>
                  <svg
                    width="23"
                    height="27"
                    viewBox="0 0 23 27"
        ...
        <div
          className={`fixed top-0 left-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-80 ${
