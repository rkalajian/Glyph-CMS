            ...
            <form className="flex items-center justify-between space-x-[18px]">
              <div className="relative w-full">
                <input
                  ...
                  className="h-[52px] w-full rounded-md border border-stroke bg-gray-1 pl-5 pr-[75px] text-body-color outline-none placeholder:text-secondary-color focus:border-primary dark:border-dark-3 dark:bg-transparent dark:text-dark-6"
                />
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-[30px] w-10 items-center justify-center rounded border border-stroke bg-[#F8FAFC] text-body-color dark:border-dark-3 dark:bg-dark dark:text-dark-6"
      >
        <svg
          width="22"
          height="22"
      ...
      >
        <button className="w-full rounded px-3 py-2 text-left text-sm text-body-color hover:bg-gray-2 dark:text-dark-6 dark:hover:bg-dark-2">
          Edit
        </button>
        <button className="w-full rounded px-3 py-2 text-left text-sm text-body-color hover:bg-gray-2 dark:text-dark-6 dark:hover:bg-dark-2">
          Delete
