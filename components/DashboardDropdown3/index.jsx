  ...
  return (
    <li className="group relative flex cursor-pointer items-center justify-between rounded-md p-3 hover:bg-gray-2 dark:hover:bg-dark-3">
      <a className="flex items-center gap-5" href={link}>
        <div className="relative z-10 h-9 w-9 flex-shrink-0 rounded-full border border-primary p-1 sm:h-11 sm:w-11">
          <img
            src={img}
            alt="User"
...
const InnerItem = ({ children }) => {
  return (
    <button className="w-full rounded py-2 px-3 text-left text-dark dark:text-white text-sm hover:bg-gray-2 dark:hover:bg-dark">
      {children}
    </button>
  );
};
