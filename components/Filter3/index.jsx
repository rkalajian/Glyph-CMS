          ...
          <div className="price-amount flex items-center justify-between">
            <div className="amount-input w-1/2">
              ...
              <span
                type="text"
                id="minAmount"
                className="text-block w-full rounded border-[.3px] border-stroke bg-gray-1 px-3 py-1 text-center text-sm font-semibold text-dark outline-none dark:border-dark-3 dark:bg-dark-4 dark:text-white"
              >
                200.00
              </span>
            </div>
