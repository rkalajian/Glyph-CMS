    ...
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-8">
        <input
          ...
          className="w-full rounded-md border border-stroke bg-transparent px-5 py-[14px] text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6"
        />
      </div>
    </div>
  );
...
const SelectGroup = () => {
  return (
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-8">
        <div className="relative">
          <select className="w-full appearance-none rounded-md border border-stroke bg-transparent px-5 py-[14px] text-dark-5 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:bg-dark-2">
...
const CouponBox = ({ title, button }) => {
  return (
    <div className="w-full px-4">
      ...
      <input
        type="email"
        className="mb-3 mr-5 h-[50px] w-full max-w-[325px] rounded-md border border-stroke bg-white px-5 text-base text-body-color outline-none placeholder:text-dark-6 focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6"
        placeholder="Coupon code"
      />
      <button className="mb-3 h-[50px] rounded-md bg-dark px-7 py-2 text-base font-medium text-white transition hover:bg-opacity-90 dark:bg-dark-2">
        {button}
      </button>
    </div>
  );
