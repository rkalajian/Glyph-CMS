        ...
        <div className="-mx-4 flex flex-wrap">
              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="bg-white text-left">
                    <th
                      className={`min-w-[300px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9 last:xl:pr-9`}
                    >
                      Product
                    </th>
                    <th
                      className={`min-w-[90px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9 last:xl:pr-9`}
                    >
                      Price
                    </th>
                    <th
                      className={`min-w-[150px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9 last:xl:pr-9`}
                    >
                      Quantity
                    </th>
                    <th
                      className={`min-w-[140px] px-4 py-4 text-base font-semibold text-dark first:xl:pl-9 last:xl:pr-9`}
                    >
                      Remove
                    </th>
                  </tr>
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-4/12">
            <div className="mb-8 overflow-hidden rounded-xl border border-[#e7e7e7] bg-white px-6 py-6 xs:px-8">
              ...
              <form className="items-center xs:flex">
                <input
                  ...
                  className="mb-3 flex h-10 w-full items-center rounded border border-form-stroke px-6 text-sm font-medium text-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] xs:mr-4"
                />
                <button className="mb-3 h-10 rounded bg-primary px-5 text-sm font-semibold text-white transition hover:bg-opacity-90">
                  Apply
                </button>
              </form>
            </div>
            <div className="mb-8 overflow-hidden rounded-xl border border-[#e7e7e7] bg-white px-6 py-6 xs:px-8">
              ...
              <div className="mb-5">
                <button className="flex w-full items-center justify-center rounded-md bg-primary px-10 py-[10px] text-center text-base font-normal text-white hover:bg-opacity-90">
                  Checkout
                </button>
              </div>
