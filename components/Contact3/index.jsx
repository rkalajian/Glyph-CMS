                ...
                <form>
                  <div className="-mx-4 flex flex-wrap">
                    ...
                    <div className="w-full px-4">
                      <button
                        type="submit"
                        className="rounded bg-primary px-9 py-3 text-base font-medium text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
    ...
    <div className="w-full px-4 md:w-1/2">
      <div className="mb-4">
        <input
          ...
          name={name}
          className="w-full border-b border-stroke bg-transparent py-4 text-sm text-body-color outline-none placeholder:opacity-50 focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
        />
      </div>
    </div>
  );
    ...
    <div className="w-full px-4">
      <div className="mb-10">
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none border-b border-stroke bg-transparent py-4 text-sm text-body-color outline-none placeholder:opacity-50 focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
