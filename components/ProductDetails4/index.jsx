            ...
            <div className="-mx-4 flex flex-wrap">
              ...
              <div className="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  <div className="flex">
                    <p className="mr-4 mb-5 inline-flex items-center rounded border border-stroke dark:border-dark-3 text-base font-medium text-dark dark:text-white">
                      <span 
                    ...
                    <button className="text-primary flex h-[42px] w-[42px] items-center justify-center rounded border border-stroke dark:border-dark-3">
                      <svg
                        width={20}
                        height={20}
                        viewBox="0 0 20 20"
