            ...
            <div className="flex items-center justify-end">
              <div className="relative mr-9 hidden w-full max-w-[250px] lg:block">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full rounded-full border border-stroke bg-gray-2 py-[6px] pl-[18px] pr-8 text-sm text-body-color outline-none focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-dark-6"
                />
