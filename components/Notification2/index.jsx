  ...
  return (
    <section className="bg-gray-2 dark:bg-dark py-[60px]">
      <div className="mx-auto px-4 sm:container">
        <div className="border-stroke dark:border-dark-3 shadow-pricing-4 dark:shadow-box-dark relative flex max-w-[422px] items-center rounded-lg border bg-white dark:bg-dark-2 p-4 py-[18px] sm:px-[30px]">
          ...
          <div className="flex w-full items-center justify-between">
            ...
            <button className="hover:text-red text-dark-5">
              <svg
                width={18}
                height={18}
                viewBox="0 0 18 18"
