                  ...
                  <div className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full md:w-1/2">
                      ...
                      <div className="flex flex-wrap md:justify-end gap-3">
                        <a
                          href="/#"
                          className="bg-gray-2 dark:bg-dark text-body-color hover:bg-primary flex h-[34px] w-[34px] items-center justify-center rounded hover:text-white"
                        >
                          <svg
                            width={18}
                            height={18}
          ...
          <div className="w-full px-4 lg:w-4/12">
            <div className="mb-10 rounded-[10px] bg-white dark:bg-dark-2">
              ...
              <div className="border-t border-stroke dark:border-dark-3 pt-7 pb-8 px-8">
                ...
                <a
                  href="/#"
                  className="mt-4 flex w-full items-center justify-center rounded-md bg-dark py-3 px-10 text-center text-base font-medium text-white hover:bg-opacity-90"
                >
                  Live Demo
                </a>
              </div>
...
const TagItem = ({ tag }) => {
  return (
    <button className="bg-primary/[0.08] text-dark dark:text-white hover:bg-primary inline-block rounded py-[5px] px-[14px] text-base hover:text-white">
      {tag}
    </button>
  );
};
