                ...
                <div className="mb-2">
                  <div className="relative z-20 inline-block rounded">
                    <select
                      name=""
                      id=""
                      className="relative z-20 inline-flex appearance-none rounded-md border border-stroke bg-transparent py-[9px] pl-3 pr-10 text-sm text-body-color outline-none dark:border-dark-3 dark:text-dark-6"
                    >
...
const MapItem = ({ img, name, percent }) => {
  return (
    <div className="items-center sm:flex">
      ...
      <div className="relative block h-[18px] w-full rounded bg-[#E5E7EB] dark:bg-dark-3">
        <div
          className="absolute left-0 top-0 flex h-full w-[35%] items-center justify-center rounded bg-primary text-xs font-medium text-white"
          style={{ width: percent }}
        >
          {percent}
        </div>
